0 cls:t=300:n=9:fori=0ton:a(i)=3*(imod5)+80*(i\5)+40:next:l$="XXX":?chr$(27)"VXXX 0
...
50 h=h+1:k$=inkey$:ifk$<>""thenm$=k$:ifm$=" "andb=0thenb=t-40
60 ifm$="j"orm$="l"then?@t,"  ":t=t+(m$="j")-(m$="l")

...
0cls:?"Initializing...":definta-z:nr=35:na=9:nv=20:no=28:nb=5:gosub10000:cls:r=1:e$=chr$(27):?e$"pUSS Ventur NCC-73209"e$"q
...
20000dataYour Quarters,3,i,4,p,2,sb,3,Closet,1,sb,1,Head,1,p,1,Passageway,3,o,1,cw,5,ccw,11,Passageway,2,cw,6,ccw,4
...
20020dataPassageway,2,cw,4,ccw,10,Turbolift,1,out,7,Bridge/Command Dais,4,f,14,p,18,sb,19,a,12,Bridge/Center,3,p,15,sb,16,a,13
20030dataBridge/Helm,2,sb,14,a,18,Bridge/Navigation,2,p,14,a,19,Unused,1,p,17,Bridge/Ops,2,f,15,sb,13,Bridge/Comms,2,p,13,f,16
20040dataMain Engineering,2,f,12,a,21,Warp core,3,f,20,p,22,sb,24,Jeffries Tube,2,sb,21,p,23,Jeffries Tube,1,sb,22
20050dataJeffries Tube,2,p,21,sb,25,Jeffries Tube,1,p,24,Armory,1,o,29,Sick bay,1,i,28,Passageway,3,o,27,cw,29,ccw,35
...
22000datacw,clockwise,ccw,counterclockwise,i,inboard,o,outboard,p,port,sb,starboard,a,aft,f,forward,out,out
